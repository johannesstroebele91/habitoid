...
export class HabitsComponent implements OnInit {
  ...
  typeBasedColDefs(metricType: HabitType): (ColDef | ColGroupDef)[] {
    ...
    if (metricType === HabitType.ProactiveCheckbox) {
      return [ACTIONS_COL, SOLUTION_COL, PROBLEM_COL, TARGET_COL, PROACTIVE_CHECKBOX_METRIC_COL, ...PROGRESS_COLS];
    } else if (metricType === HabitType.ProactiveNumeric) {
      return [ACTIONS_COL, SOLUTION_COL, PROBLEM_COL, TARGET_COL, PROACTIVE_NUMERIC_METRIC_COL, ...PROGRESS_COLS];
    } else {
