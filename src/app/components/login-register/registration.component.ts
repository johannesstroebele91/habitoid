...
export class RegistrationComponent {
  ...
  usersHabitsService = inject(UsersHabitsService);
      ...
      this.authService
        ...
        .subscribe({
          ...
          next: (response: AuthResponseData) => {
            this.usersHabitsService.createUserWithDefaultHabits(response.localId, name).subscribe({
              next: () => {
                void this.router.navigate([`/home/${response.localId}`]);
